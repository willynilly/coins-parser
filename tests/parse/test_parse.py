...
def test_parse_html_with_single_non_coins_span():
    run_test(test_group="parse", test_name="single_non_coins_span")


def test_parse_html_with_single_empty_coins_span():
    run_test(test_group="parse", test_name="single_empty_coins_span")


def test_parse_html_with_multiple_empty_coins_spans():
    run_test(test_group="parse", test_name="multiple_empty_coins_spans")


def test_parse_html_with_single_non_empty_coins_span():
    run_test(test_group="parse", test_name="single_non_empty_coins_span")
